...
class Banner extends \Magento\Backend\Block\Widget\Grid\Extended implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    {
        /** @var \Neosoft\BannerSlider\Model\ResourceModel\Banner\Collection $collection */
    ...
    /**
     * @param \Neosoft\BannerSlider\Model\Banner|\Magento\Framework\Object $item
     * @return string
     */
    ...
    {
        return $this->coreRegistry->registry('neosoft_bannerslider_slider');
    }
    ...
    {
        return $this->getUrl('neosoft_bannerslider/slider/banners', ['_current' => true]);
    }
