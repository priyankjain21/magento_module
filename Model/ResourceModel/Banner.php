...
namespace Neosoft\BannerSlider\Model\ResourceModel;
...
class Banner extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    )
    {
        ...
        $this->bannerSliderTable = $this->getTable('neosoft_bannerslider_banner_slider');
    }
    ...
    {
        $this->_init('neosoft_bannerslider_banner', 'banner_id');
    }
     ...
     *
     * @param \Magento\Framework\Model\AbstractModel|\Neosoft\BannerSlider\Model\Banner $object
     * @return $this
     */
     ...
     * @return array
     */
    public function getSlidersPosition(\Neosoft\BannerSlider\Model\Banner $banner)
    {
     ...
     * @return $this
     */
    protected function saveSliderRelation(\Neosoft\BannerSlider\Model\Banner $banner)
    {
        ...
        if (!empty($insert) || !empty($delete)) {
            ...
            $this->eventManager->dispatch(
                'neosoft_bannerslider_banner_change_sliders',
