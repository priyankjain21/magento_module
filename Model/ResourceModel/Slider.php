...
class Slider extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    )
    {
        ...
        $this->sliderBannerTable = $this->getTable('neosoft_bannerslider_banner_slider');
    }
    ...
    {
        $this->_init('neosoft_bannerslider_slider', 'slider_id');
    }
     ...
     *
     * @param \Magento\Framework\Model\AbstractModel|\Neosoft\BannerSlider\Model\Slider $object
     * @return $this
     */
     ...
     * @return array
     */
    public function getBannersPosition(\Neosoft\BannerSlider\Model\Slider $slider)
    {
     ...
     * @return $this
     */
    protected function saveBannerRelation(\Neosoft\BannerSlider\Model\Slider $slider)
    {
        ...
        if (!empty($insert) || !empty($delete)) {
            ...
            $this->eventManager->dispatch(
                'neosoft_bannerslider_slider_change_banners',
